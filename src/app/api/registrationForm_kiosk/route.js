...
import cookie from "cookie"; // Para configurar os cookies
...
export async function POST(req) {
  try {
    ...
    const redirectUrl = `http://localhost:3000/homepage/frontOfficeView/registrationForm?propertyID=${propertyID}&requestID=${requestID}&resNo=${resNo}&profileID=${profileID}&token=${token}`;
